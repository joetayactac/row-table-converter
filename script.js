(function () {
  ...
  let columns = [
    { header: "Vehicle No", column: "VEHICLE NO", sample: "382231" },
    { header: "Vehicle Name", column: "VEHICLE NAME", sample: "Mercedes S450" },
    { header: "Reg Month", column: "REG MONTH", sample: "November" }
  ];
